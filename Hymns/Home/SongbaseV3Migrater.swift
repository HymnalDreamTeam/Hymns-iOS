        ...
        if !favoritesMigrated {
            mainQueue.async {
                ...
                .sink(receiveCompletion: { state in
                    ...
                    // Set task to nil this doesn't trigger again because of these updates, causing an infinite loop
                    self.migrateFavoritesTask = nil

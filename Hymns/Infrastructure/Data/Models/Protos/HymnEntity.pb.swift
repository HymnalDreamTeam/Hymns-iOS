...
// Source: Hymns/Infrastructure/Data/Models/Protos/HymnEntity.proto
//
...
enum HymnType: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  case chineseSupplement // = 9
  case chineseSupplementSimplified // = 10
  case cebuano // = 11
  case tagalog // = 12
  case french // = 13
  case spanish // = 14
  ...
  init?(rawValue: Int) {
    ...
    case 9: self = .chineseSupplement
    case 10: self = .chineseSupplementSimplified
  ...
  var rawValue: Int {
    ...
    case .chineseSupplement: return 9
    case .chineseSupplementSimplified: return 10
...
extension HymnType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    9: .same(proto: "CHINESE_SUPPLEMENT"),
    10: .same(proto: "CHINESE_SUPPLEMENT_SIMPLIFIED"),

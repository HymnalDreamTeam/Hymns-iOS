        ...
        describe("ChordLineViewModel") {
            ...
            describe("init") {
                context("has one chord") {
                    let chordLine = ChordLineEntity([ChordWordEntity("word 1"), ChordWordEntity("word 2", chords: "C"), ChordWordEntity("word 3")])
                    beforeEach {
                ...
                context("has two chord") {
                    let chordLine = ChordLineEntity([ChordWordEntity("word 1", chords: "D"), ChordWordEntity("word 2", chords: "C"), ChordWordEntity("word 3")])
                    beforeEach {
                        target = ChordLineViewModel(chordLine: chordLine)
                    }
                    it("should have chords") {
                ...
                context("does not have chords") {
                    let chordLine = ChordLineEntity([ChordWordEntity("word 1"), ChordWordEntity("word 2"), ChordWordEntity("word 3")])
                    beforeEach {
                        target = ChordLineViewModel(chordLine: chordLine)
                    }

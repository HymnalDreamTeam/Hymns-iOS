...
let songbase1 = HymnIdentifier(hymnType: .songbaseOther, hymnNumber: "1")
...
let children_24_hymn_entity = HymnEntity.with { builder in
    ...
    builder.lyrics = LyricsEntity(
        [VerseEntity(verseType: .verse,
         ...
         VerseEntity(verseType: .verse,
                     lineStrings: ["Don’t stay home! (go, go!)", "Go and visit people!", "Don’t stay home! (go, go!)",
         ...
         VerseEntity(verseType: .other,
                     lineStrings: ["\n", "© 2012 Bible StorySongs, Inc. Used by permission.",
                                   "Visit BibleStorySongs.com to order CD’s & Sheet Music.", "\n"])])
    builder.category = ["Preaching of the Gospel"]
    builder.subcategory = ["Go Ye!"]
    builder.author = ["P. K.", "C. R. W."]
    builder.composer = ["Traditional (1908)"]
    builder.key = ["E Major"]
    builder.time = ["4/4"]
    builder.hymnCode = ["5332153322172"]
    builder.music = MusicEntity(["mp3": "/en/hymn/c/24/f=mp3", "MIDI": "/en/hymn/c/24/f=mid", "Tune (MIDI)": "/en/hymn/c/24/f=tune"])!
    builder.svgSheet = SvgSheetEntity.with { builder in
        builder.svgSheet = ["Piano": "https://www.hymnal.net/Hymns/Children/svg/child0024_p.svg",
                            "Guitar": "https://www.hymnal.net/Hymns/Children/svg/child0024_g.svg"]
    }
    builder.pdfSheet = PdfSheetEntity.with { builder in
        builder.pdfSheet = ["Piano": "/en/hymn/c/24/f=ppdf",
...
let classic_1151_hymn_reference = HymnReference(
    hymnIdEntity: HymnIdEntity(hymnIdentifier: classic1151, songId: 2),
    hymnEntity: HymnEntity.with { builder in
        builder.id = 2
        builder.title = "Hymn: Drink! A river pure and clear that's flowing from the throne"
        builder.lyrics = LyricsEntity(
            [VerseEntity(verseType: .verse,
                         lineStrings: ["Drink! A river pure and clear that's flowing from the throne;",
             ...
             VerseEntity(verseType: .chorus,
                         lineStrings: ["Do come, oh, do come,",
             ...
             VerseEntity(verseType: .verse,
                         lineStrings: ["Christ, our river, Christ, our water, springing from within;",
             ...
             VerseEntity(verseType: .verse,
                         lineStrings: ["We are washing all our robes the tree of life to eat;",
                                       "\"O Lord, Amen, Hallelujah!\"—Jesus is so sweet!",
                                       "We our spirits exercise, and thus experience Christ.",
                                       "What a Christ have we!"]),
             VerseEntity(verseType: .verse,
                         lineStrings: ["Now we have a home so bright that outshines the sun,",
...
let classic_1109_hymn_entity = HymnReference(
    hymnIdEntity: HymnIdEntity(hymnIdentifier: classic1109, songId: 3),
    hymnEntity: HymnEntity.with { builder in
        builder.id =  3
        builder.title = "Hymn: Take, drink this cup, His blood"
        builder.lyrics = LyricsEntity (
            [VerseEntity(verseType: .verse,
                         lineStrings: ["Take, drink this cup, His blood,", "Redemption of our God.", "The peace which Christ has made,",
                                       "Is in this cup displayed.", "We fellowship now with the Son:", "On Calvary the work was done:",
                                       "The way is clear, now all can come!"]),
             VerseEntity(verseType: .verse,
                         lineStrings: ["Take, drink this cup, each one,", "His death show till He come.", "Eat, drink, display this feast:",
             ...
             VerseEntity(verseType: .verse,
                         lineStrings: ["No blood of cow or goat", "Could give us any hope.", "Our sins would all remain",
                                       "Still year by year the same.", "A God-man, sinless, He must find", "No other offering of His kind,",
                                       "A spotless lamb for all mankind."]),
             VerseEntity(verseType: .verse,
                         lineStrings: ["Come! Now enjoy His blood.", "What access this to God!", "Here wondrous cleansing power",
             ...
             VerseEntity(verseType: .verse,
                         lineStrings: ["Redeemer! Savior! King!", "Of Thy dear blood we sing,", "For in it now we see",
